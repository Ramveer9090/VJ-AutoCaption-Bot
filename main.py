...
try: app_id = int(os.environ.get("app_id", "28973954"))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "7b58b23ff8c394779cd64c3c906cd751")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "7091769736:AAEx4vuodqal8SUuXao13fxmaejECl7mBcA")
except Exception as bot_token: print(f"⚠️ Bot Token Invalid {bot_token}")
try: custom_caption = os.environ.get("custom_caption", "`{file_name}`By -😈@Sheero90_bot😈")
...
<b>@AUTOCAPTIONVIDEOS978</b>"""

about_message = """
<b>• Name : <a href=https://t.me/AUTOCAPTIONVIDEOS978>VJ AutoCaption</a></b>
<b>• Developer : <a href=https://t.me/VJ_Botz>[VJ UPDATES]</a></b>
<b>• Language : Python3</b>
<b>• Library : Pyrogram v{version}</b>
<b>• Updates : <a href=https://t.me/AUTOCAPTIONVIDEOS978>Click Here</a></b>
...
def start_buttons(bot, update):
  bot = bot.get_me()
  buttons = [[
   pyrogram.types.InlineKeyboardButton("Updates", url="t.me/AUTOCAPTIONVIDEOS978"),
   pyrogram.types.InlineKeyboardButton("About 🤠", callback_data="about")
   ],[
   pyrogram.types.InlineKeyboardButton("➕️ Add To Your Channel ➕️", url=f"http://t.me/autocc90_bot?startchannel=true")
   ]]
...
print("https://t.me/AUTOCAPTIONVIDEOS978")
